...
ButtonStruct buttons[NUM_BUTTONS] = {
  ...
  { button2,  12, TG_SQR1,              BTN_ACTION_NONE, TG_MANUAL_ALL,       BTN_ACTION_NONE, /* ALT: */ TG_RESO_AMP_COMP,         BTN_ACTION_NONE, BTN_ACTION_NONE, BTN_ACTION_NONE, 0, 0 },
  ...
  { button9,  23, TG_LFO2_WAVE,         BTN_ACTION_NONE, TG_FUNC,             BTN_ACTION_NONE, /* ALT: */ PRESET_SAVE_SELECT_MODE,  BTN_ACTION_NONE, SAVE_PRESET,     BTN_ACTION_NONE, 0, 0 },
